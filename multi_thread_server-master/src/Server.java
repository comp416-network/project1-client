...
public class Server
{
    ...
    private void ListenAndAccept()
    {
        ...
        try
        {
            ...
            System.out.println("A connection was established with a client on the address of " + s1.getRemoteSocketAddress());
            s2 = serverSocket.accept();
            System.out.println("A connection was established with a client on the address of " + s2.getRemoteSocketAddress());
